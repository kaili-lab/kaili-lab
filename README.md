...
- [chatbot-base](https://github.com/kaili-lab/chatbot-base) — RAG chatbot for chatting with uploaded documents (Vercel AI SDK)

**AI-Enhanced Full-Stack**
- [vocab-master](https://github.com/kaili-lab/vocab-master) — Context-aware vocabulary learning app with spaced repetition
- [ai-blog](https://github.com/kaili-lab/ai-blog) — Blog platform with AI-generated summaries, cover images, and vector search
